		...
		<form method="post" name="learndash_course_reviews" action="reviews_process_review">
			...
			<div class="grid-container full">
				...
				<div class="grid-x">
					<div class="small-12 cell">
						<label for="learndash-course-reviews-review-title">
							<?php esc_html_e( 'Review Title', 'learndash-course-reviews' ); ?> <span class="required">*</span>
						</label>
						<input 
							type="text"
				...
				<div class="grid-x">
					<div class="small-12 cell">
						<label for="learndash-course-reviews-review">
							<?php esc_html_e( 'Rating', 'learndash-course-reviews' ); ?> <span class="required">*</span>
						</label>
				...
				<div class="grid-x">
					<div class="small-12 cell">
						<label for="learndash-course-reviews-review">
							<?php esc_html_e( 'Review', 'learndash-course-reviews' ); ?> <span class="required">*</span>
						</label>
						<textarea
				...
				<div class="grid-x">
					<div class="small-12 cell">
						<input
							...
							value="<?php esc_attr_e( 'Post Review', 'learndash-course-reviews' ); ?>"
							data-saving_text="<?php esc_attr_e( 'Submitting...', 'learndash-course-reviews' ); ?>"
						/>
					</div>
				</div>
				...
				echo esc_html(
					...
					apply_filters(
						...
						sprintf(
							...
							__( 'You must log in and have started this %s to submit a review.', 'learndash-course-reviews' ),
			...
			<p class="learndash-course-reviews-not-allowed">
				...
				echo esc_html(
					...
					apply_filters(
						...
						sprintf(
							// translators: Lowercase "Course" label.
							__( 'You must have started this %s to submit a review.', 'learndash-course-reviews' ),
							learndash_get_custom_label_lower( 'course' )
						)
					)
				);
