				...
				<div class="learndash-course-reviews-meta">
								...
								<div class="learndash-course-reviews-metadata">
									...
									echo wp_kses_post(
										sprintf(
											...
											__( '<span class="author">By %s</span> on ', 'learndash-course-reviews' ),
										...
										<time datetime="<?php comment_time( 'c' ); ?>">
											...
											echo esc_html(
												sprintf(
													...
													__( '%1$s at %2$s', 'learndash-course-reviews' ),
													get_comment_date(),
													get_comment_time()
												)
											);
									...
									</a> <?php edit_comment_link( __( 'Edit', 'learndash-course-reviews' ), '<span class="edit-link">', '</span>' ); ?>
								</div>
					...
					<?php if ( '0' === $comment->comment_approved ) : ?>
						<p class="learndash-course-reviews-awaiting-moderation">
							<i>
								<?php esc_html_e( 'Your review is awaiting moderation.', 'learndash-course-reviews' ); ?>
							</i>
						</p>
					<?php endif; ?>
				</div>
