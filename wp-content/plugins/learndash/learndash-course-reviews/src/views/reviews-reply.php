...
<div id="learndash-course-reviews-reply" style="display: none">
	<h3 id="learndash-course-reviews-reply-heading" class="learndash-course-reviews-heading">
		<?php esc_html_e( 'Leave a reply', 'learndash-course-reviews' ); ?> <small>
			<a rel="nofollow" id="cancel-comment-reply-link" href="#">
				<?php esc_html_e( 'Cancel reply', 'learndash-course-reviews' ); ?>
			</a>
		</small>
	</h3>
			...
			<div class="grid-x">
				<div class="small-12 cell">
					<label for="learndash-course-reviews-review">
						<?php esc_html_e( 'Comment', 'learndash-course-reviews' ); ?> <span class="required">*</span>
					</label>
			...
			<div class="grid-x">
				<div class="small-12 cell">
					<input
						...
						value="<?php esc_attr_e( 'Post Reply', 'learndash-course-reviews' ); ?>"
					/>
				</div>
			</div>
		</div>
