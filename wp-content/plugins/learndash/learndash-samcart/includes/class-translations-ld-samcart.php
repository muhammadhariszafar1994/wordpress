<?php
if ( ( class_exists( 'LearnDash_Settings_Section' ) ) && ( !class_exists( 'LearnDash_Settings_Section_Translations_Learndash_Samcart' ) ) ) {
	class LearnDash_Settings_Section_Translations_Learndash_Samcart extends LearnDash_Settings_Section {

		// Must match the Text Domain
		private $project_slug = 'learndash-samcart';
		...
		function __construct() {
			...
			$this->settings_section_label			=	__( 'LearnDash Samcart', 'learndash-samcart' );
			...
			if ( class_exists( 'LearnDash_Translations' ) ) {
				...
				if ( method_exists( 'LearnDash_Translations', 'register_translation_slug' ) ) {
					...
					LearnDash_Translations::register_translation_slug( $this->project_slug, LEARNDASH_SAMCART_PLUGIN_PATH . 'languages' );
				} 
			} 
	...
	add_action( 'init', function() {
		LearnDash_Settings_Section_Translations_Learndash_Samcart::add_section_instance();
	} );
}
