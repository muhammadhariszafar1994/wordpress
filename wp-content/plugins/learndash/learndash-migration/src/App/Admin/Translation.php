...
class Translation extends LearnDash_Settings_Section {
	 ...
	 * @var string
	 */
	private $project_slug = 'learndash-migration';
	...
	public function __construct() {
		...
		$this->settings_section_label = __( 'LearnDash LMS - Migration', 'learndash-migration' );
		...
		if (
			...
			LearnDash_Translations::register_translation_slug( $this->project_slug, LEARNDASH_MIGRATION_PLUGIN_DIR . 'languages' );
		}
