<?php
if ( ( class_exists( 'LearnDash_Settings_Section' ) ) && ( !class_exists( 'LearnDash_Settings_Section_Translations_Learndash_Event_Espresso' ) ) ) {
	class LearnDash_Settings_Section_Translations_Learndash_Event_Espresso extends LearnDash_Settings_Section {

		// Must match the Text Domain
		private $project_slug = 'learndash-event-espresso';
		...
		function __construct() {
			...
			$this->settings_section_label			=	__( 'LearnDash Event Espresso', 'learndash-event-espresso' );
			...
			if ( class_exists( 'LearnDash_Translations' ) ) {
				...
				if ( method_exists( 'LearnDash_Translations', 'register_translation_slug' ) ) {
					...
					LearnDash_Translations::register_translation_slug( $this->project_slug, LEARNDASH_EE_PLUGIN_PATH . 'languages' );
				} 
			} 
	...
	add_action( 'init', function() {
		LearnDash_Settings_Section_Translations_Learndash_Event_Espresso::add_section_instance();
	} );
}
