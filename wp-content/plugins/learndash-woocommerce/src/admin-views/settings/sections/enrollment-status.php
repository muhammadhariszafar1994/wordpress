...
<p class="description">
	...
	printf(
		...
		esc_html__(
			'%1$sWarning:%2$s The "On Hold" subscription status should be left as Grant in order to prevent students from losing access when a subscription renewal processes.',
